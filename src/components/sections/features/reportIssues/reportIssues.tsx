...
export const ReportIssues = () => {
  return (
    <VStack padding="2.5rem 5rem">
      <Box>
        <Text fontSize="5xl" fontWeight="bold" mb={4}>Report or Request</Text>
      </Box>

      <Box>
        <Text fontSize="lg">Report an issue you are experiencing or request a feature to be added.</Text>
      </Box>
